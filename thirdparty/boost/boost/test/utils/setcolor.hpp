...
struct scope_setcolor {
    ...
    scope_setcolor(scope_setcolor&& other) : m_os(other.m_os) {
        other.m_os = NULL;
    }
    ~scope_setcolor()
    {
...
private:
    ...
    scope_setcolor(scope_setcolor const&);
    scope_setcolor& operator=(scope_setcolor const&);
};

#define BOOST_TEST_SCOPE_SETCOLOR( is_color_output, os, attr, color )       \
    ::boost::unit_test::utils::scope_setcolor const sc = is_color_output    \
           ? ::boost::unit_test::utils::scope_setcolor( os, attr, color )   \
           : ::boost::unit_test::utils::scope_setcolor();                   \
    ::boost::unit_test::ut_detail::ignore_unused_variable_warning( sc )     \
/**/
